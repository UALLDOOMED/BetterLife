 ...
 */
if ( ! function_exists( 'kids_love_add_about_section' ) ) :
    /**
    * Add about section
    *
    *@since Kids Love 1.0.0
    */
    function kids_love_add_about_section() {
    	$options = kids_love_get_theme_options();
        // Check if about is enabled on frontpage
        $about_enable = apply_filters( 'kids_love_section_status', true, 'about_section_enable' );
        ...
        $section_details = apply_filters( 'kids_love_filter_about_section_details', $section_details );
        ...
        kids_love_render_about_section( $section_details );
    }
endif;

if ( ! function_exists( 'kids_love_get_about_section_details' ) ) :
    /**
    ...
    */
    function kids_love_get_about_section_details( $input ) {
        $options = kids_love_get_theme_options();
...
add_filter( 'kids_love_filter_about_section_details', 'kids_love_get_about_section_details' );


if ( ! function_exists( 'kids_love_render_about_section' ) ) :
  /**
   * Start about section
   *
   ...
   *
   */
   function kids_love_render_about_section( $content_details = array() ) {
        $options = kids_love_get_theme_options();
                            ...
                            if ( ! empty( $content['url'] ) && ! empty( $options['about_btn_title'] ) ) : ?>
                                <div class="read-more">
                                    <a href="<?php echo esc_url( $content['url'] ) ?>" class="btn">
                                        <?php 
                                            echo esc_html( $options['about_btn_title'] ); 
