...
class Kids_Love_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'kids_love';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'kids-love' ), $i ),
...
// Initialize.
$kids_love_footer_widgets = new Kids_Love_Footer_Widgets();
