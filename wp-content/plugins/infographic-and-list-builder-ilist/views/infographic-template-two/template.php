			...
			<div class="ilist_sl2_qcld_style <?php echo $rtlClass; ?>" ><!--col-md-6 col-sm-6-->
			   ...
			   <div class="ilist_sl2_list-inner-part-two sl2hoveritem sl2hovertextcolor" >
					...
					<div class="upvote-section" style="cursor:pointer">
						<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo (trim($list['qcld_text_title'])); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on">
					...
					<?php endif; ?>					
						<h2 >
							<div class="infog5_title_image">
								<?php
								if(isset($list['qcld_text_image']) and $list['qcld_text_image']!=''){
