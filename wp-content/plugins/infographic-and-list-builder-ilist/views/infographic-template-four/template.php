							...
							<div class="ilist_info4_top-14">
								<h2>
									...
									<div class="upvote-section" style="font-size: 14px;margin-right: 21px;float: right;">
										<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo esc_html__(trim($list['qcld_text_title'])); ?>" data-item-desc="<?php echo esc_html__(trim($list['qcld_text_desc'])); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on" style="overflow: hidden;width: 21px;display: block;float: left;">
							...
							<div class="ilist_info4_bottom-14">
								...
								<?php 
									if($list['qcld_text_desc']!=''){
										echo '<p>'.esc_html__($list['qcld_text_desc']).'</p>';
									}
								?>
								</div>
							</div>
				...
				<div class="ilist_info4_col-6"><!--col-6-->
				   <div class="ilist_info4_list-inner-part-14">
						...
						<div class="ilist_info4_icon-image ilist_info4_left-side">
							<?php if($list['qcld_text_image']!=''){
								echo '<a class="example-image-link" href="'. esc_url($list['qcld_text_image']) .'" data-lightbox="example-'. $cnt.'"><img style="max-width: 100%;margin: -11px;" class="ilist_info4_example-image" src="'. esc_url($list['qcld_text_image']).'" alt="image-1" /></a>';
							}else{
