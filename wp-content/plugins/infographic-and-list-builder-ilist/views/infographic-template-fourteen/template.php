		...
		<li id="qcld_sl_<?php echo get_the_ID()."_".$cnt ?>" class="list-style-fourteen list-style-fourteen-01 ilist_pinfog2_<?php echo $column; ?>">
                        <div class="list-fourteen-inner-part">
                            <div class="list-fourteen-sl">
                                <h2 <?php echo $itemnumbercolor; ?>><?php echo ($cnt>9?$cnt:'0'.$cnt); ?></h2>
                            </div>
                            <div class="list-fourteen-content pinfo2hoveritem pinfo2hovertitlecolor pinfo2hoverdesccolor ori7itembgcolor" >
                                
							<?php 
								if(isset($list['qcld_text_title']) and $list['qcld_text_title']!=''){
							?>
				...
				<div class="upvote-section" style="cursor:pointer">
					<span data-post-id="<?php echo get_the_ID(); ?>" data-item-title="<?php echo trim($list['qcld_text_title']); ?>" data-item-id="<?php echo esc_html__(trim($list['qcld_counter'])); ?>" class="upvote-btn-ilist upvote-on" style="">
				...
				<div style="clear:both"></div>								
                                <span <?php echo $subtitlecolor; ?> class="pinfo2descfont pinfog2dfontsize">							
								<?php 
							...
							<?php if(isset($list['qcld_text_image']) && $list['qcld_text_image']!=''){ ?>
							...
							<?php }elseif(isset($list['qcld_text_image_fa']) and $list['qcld_text_image_fa']!=''){
