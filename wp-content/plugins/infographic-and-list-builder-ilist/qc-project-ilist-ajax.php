				...
				<?php else : ?>
					...
					<?php foreach($val as $k=>$v) : ?>
							...
							<div class="ilist_list_elem_pro" data="<?php echo $k; ?>">
								<a href="https://www.quantumcloud.com/products/infographic-maker-ilist/" target="_blank"><img style="width:150px" src="<?php echo plugins_url( 'alltemplate/'.$k.'/screenshot.jpg', __FILE__ ); ?>" />
							</div>
	...
	<div id="ilist-modal" class="ilist_shortcode_modal">
		...
		<div class="ilist-modal-content">
			...
			<div class="sm_shortcode_list">
				...
				<div class="ilist_single_field_shortcode">
					<label style="width: 200px;display: inline-block;margin-top: 22px;">Disable Lightbox</label>
					<div class="switchilist demo3">
			...
			<div class="qcpd_single_field_shortcode">
				...
				<p><b>Copy</b> the shortcode & use it any text block. <button class="ilist_copy_close button button-primary button-small" style="float:right">Copy & Close</button></p>
            </div>
		</div>
